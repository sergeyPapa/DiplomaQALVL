...
public class CreditPageTest {
    ...
    void shouldPaymentWithApprovedCard() throws SQLException {
        ...
        CardInfo card = new CardInfo(getFirstCardNumber(), getMonthCard(1), getYearCard(2), getOwnerCard(), getCvc());
    ...
    void shouldPaymentWithApprovedCardExpires() throws SQLException {
        var startPage = new StartPage();
        CardInfo card = new CardInfo(getFirstCardNumber(), getMonthCard(0), getYearCard(0), getOwnerCard(), getCvc());
        var creditPage = startPage.paymentOnCredit();
        creditPage.getFillCardDetails(card);
        creditPage.successfulPaymentCreditCard();
        String actual = DbInteractionDbUtils.getStatusCredit();
    ...
    void shouldPaymentWithDeclinedCard() throws SQLException {
        var startPage = new StartPage();
        CardInfo card = new CardInfo(getSecondCardNumber(), getMonthCard(0), getYearCard(1), getOwnerCard(), getCvc());
        var creditPage = startPage.paymentOnCredit();
        creditPage.getFillCardDetails(card);
    ...
    void shouldPaymentWithDeclinedCardExpires() throws SQLException {
        var startPage = new StartPage();
        CardInfo card = new CardInfo(getSecondCardNumber(), getMonthCard(0), getYearCard(0), getOwnerCard(), getCvc());
        var creditPage = startPage.paymentOnCredit();
        creditPage.getFillCardDetails(card);
        creditPage.invalidPaymentCreditCard();
        String actual = DbInteractionDbUtils.getStatusCredit();
    ...
    void shouldPaymentWithInvalidCardNumber() {
        var startPage = new StartPage();
        CardInfo card = new CardInfo(getInvalidCardNumber(), getMonthCard(2), getYearCard(1), getOwnerCard(), getCvc());
        var creditPage = startPage.paymentOnCredit();
        creditPage.getFillCardDetails(card);
        creditPage.invalidPaymentCreditCard();
    }
    ...
    void shouldPaymentWithInvalidCardNumberShort() {
        var startPage = new StartPage();
        CardInfo card = new CardInfo(getInvalidShortCardNumber(), getMonthCard(2), getYearCard(1), getOwnerCard(), getCvc());
        var creditPage = startPage.paymentOnCredit();
        creditPage.getFillCardDetails(card);
    ...
    void shouldPaymentExpiredCard() {
        var startPage = new StartPage();
        CardInfo card = new CardInfo(getFirstCardNumber(), getMonthCard(0), getYearCard(-1), getOwnerCard(), getCvc());
        var creditPage = startPage.paymentOnCredit();
        creditPage.getFillCardDetails(card);
    ...
    @Test
    public void shouldPaymentCardNullCvc() {
        var startPage = new StartPage();
        CardInfo card = new CardInfo(
